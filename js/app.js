...
const game = {
	...
	drawElapsedTime: function() {
		...
		ctx.globalAlpha = 0.5;
		ctx.fillText(elapsed + " secs", canvas.width - 200, 25);
		ctx.restore();
	...
	collision: function(rectA, rectB) {
		return !(
...
const biker = {
	...
	move: function(key) {
		...
		if (this.height >= canvas.height - 50) {
